...
> sudo mkdir Animals_world

> ls

> sudo mv Friends_of_Man Animal_world/
...
> sudo dpkg -i https://dev.mysql.com/get/mysql-apt-config_0.8.24-1_all.deb
...
![alt text](horses_with_donkeys.png)
...
![alt text](union_all_remaining.png)
...
Введение не корректных данных в программе
